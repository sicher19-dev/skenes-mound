    ...
    <div style={S.ct}>
      ...
      <div style={{marginTop:14}}>
        ...
        <div style={{padding:'12px 14px',borderRadius:8,background:'#111',border:'1px solid #1a1a2a',lineHeight:1.7,fontSize:12,color:'#bbb'}}>
          ...
          <p style={{margin:0,color:'#888',fontSize:11}}>Data sourced from Baseball Savant Hawkeye 2024. Trajectory model uses quadratic Magnus buildup: x(f) = relX + (plateLoc â pfx â relX)·f + pfx·f². HAA = arctan((plateLoc â relX) / 648"). Release offset: rubber â 24" (RHP arm geometry).</p>
        </div>
      </div>
